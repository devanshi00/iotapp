...
from users.mqtt_client import publish_temperature
User = get_user_model()
...
class VitalDataConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        try:
            ...
            if self.user.is_authenticated:
                ...
                await self.accept()
                await self.channel_layer.group_add("vitals_group", self.channel_name)
    ...
    async def disconnect(self, close_code):
        ...
        await self.channel_layer.group_discard("vitals_group", self.channel_name)
        # No special action needed on disconnect
    ...
    async def receive(self, text_data):
        ...
        await publish_temperature()
    
    async def vitals_message(self, event):
        # Send the MQTT message received to the WebSocket
